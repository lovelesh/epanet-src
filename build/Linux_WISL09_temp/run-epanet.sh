...
#run the simulation
LD_LIBRARY_PATH=./:$LD_LIBRARY_PATH ./epanet_valve_optim_wisl09 ../../Input_Files/Devanoor_10DMA_demand_zero_changed_new_pattern.inp ../../Input_Files/temp_demand_all_new_pattern.csv ../../Input_Files/joblist.txt 24 ../../Input_Files/temp_valve_setting_all_new_pattern.csv|tee $filename
